...
class FacilityData extends StatefulWidget {
  _FacilityState createState() => _FacilityState();
}

class _FacilityState extends State<FacilityData> {
  String url = "http://apis.data.go.kr/B460014/foodBankInfoService2/getFcltyGrpInfo?dataType=json";
            ...
            userDataList.isEmpty
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      int facilityIdx = grapClscdId.indexOf(item['fcltyGrpClscd']);
                      ...
                      return Column(
                        children: [
                          ...
                          Row(
                            children: [
                              SizedBox(width: 7,),
                              Text("시설단체 분류", style: TextStyle(
                                  color: Colors.grey
                              ),),
                              SizedBox(width: 7),
                              Text(fcltyGrpClscd[facilityIdx])
                            ],
                          ),
                          Row(
                            children: [
                          ...
                          Row(
                            children: [
                              SizedBox(width: 7,),
                              Text("시설 단체수", style: TextStyle(
                                  color: Colors.pink
                              ),),
                              SizedBox(width: 7),
                              Text(item['fcltyGrpCo'])
                            ],
                          ),
                          SizedBox(height: 20,),
                        ],
